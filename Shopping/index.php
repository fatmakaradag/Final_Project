		...
		<div class="row">
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">30 gün içinde para iade garantisi</h6>
				</div>
			</div><!-- .col -->
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading orange">Ücretsiz Kargo</h4>
						</div>
					</div>
					<h6 class="text">100TL üzeri alışverişe ücretsiz kargo</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading red">Özel İndirimler</h4>
						</div>
					</div>
					<h6 class="text">Tüm ürünlerde %20 indiirm var </h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
...
<!-- ============================================== INFO BOXES : END ============================================== -->		
		...
		<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp">
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">ÜRÜN BİLGİLERİ</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					<li class="active"><a href="#all" data-toggle="tab">HEPSİ</a></li>
					<li><a href="#books" data-toggle="tab">KİTAPLAR</a></li>
					<li><a href="#furniture" data-toggle="tab">KOZMETİK</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
...
?>
	...
	<div class="product">		
		...
		<?php if($row['productAvailability']=='In Stock'){?>
					<div class="action"><a href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn btn-primary">Sepete Ekle</a></div>
				<?php } else {?>
						<div class="action" style="color:red">Stok Dışı</div>
					<?php } ?>
			</div><!-- /.product -->
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">Akıllı Telefonlar</h3>
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">Laptoplar</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
								...
								<div class="row product-micro-row">
									...
									<div class="col col-xs-6">
										<div class="product-info">
											...
											<div class="product-price">	
												<span class="price">
													<?php echo htmlentities($row['productPrice']);?>TL
												</span>
