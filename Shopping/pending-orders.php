		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-description item">Gorsel</th>
					<th class="cart-product-name item">Urun Adı</th>
			
					<th class="cart-qty item">Urun Adeti</th>
					<th class="cart-sub-total item">Urun Fiyatı</th>
						<th class="cart-sub-total item">Kargo Ucreti</th>
					<th class="cart-total">Toplam Tutar</th>
					<th class="cart-total item">Odeme Sekli</th>
					<th class="cart-description item">Siparis Tarihi</th>
					<th class="cart-total last-item">Durum</th>
				</tr>
			</thead><!-- /thead -->
...
?>
				<tr>
					...
					<td><a href="pending-orders.php?id=<?php echo $row['oid']; ?> ">Sil</td>
				</tr>
<?php $cnt=$cnt+1;} ?>
<tr>
	<td colspan="9"><div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary"><a href="payment-method.php">Odeme Adımına Geç</a></button>
...
<?php } else {?>
<tr>
<td colspan="10" align="center"><h4>Sonuç Bulunamadı</h4></td>
</tr>
<?php } ?>
