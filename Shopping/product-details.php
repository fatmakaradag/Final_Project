					...
					<div class="products">
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">	
								<span class="price">
									 <?php echo htmlentities($rws['productPrice']);?>.00 TL
								</span>
						...
						<div class="cart clearfix animate-effect">
							...
							<button class="btn btn-primary" type="button">Sepete Ekle</button></a>
								<?php } else {?>
...
?>		
							<div class="rating-reviews m-t-20">
								<div class="row">
									...
									<div class="col-sm-8">
										<div class="reviews">
											<a href="#" class="lnk">(<?php echo htmlentities($num);?> Yorumlar)</a>
										</div>
									</div>
								</div><!-- /.row -->		
							</div><!-- /.rating-reviews -->
...
<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label">Ürünün Markası :</span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
...
<div class="stock-container info-container m-t-10">
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<div class="col-sm-2">
										<span class="label">Ürün Sayısı :</span>
									</div>
									...
									<div class="col-sm-7">
<?php if($row['productAvailability']=='In Stock'){?>
										<a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i> SEPETE EKLE</a>
													<?php } else {?>
					...
					<?php } ?>
							...
							<div class="product-social-link m-t-20 text-right">
								<span class="social-label">Aktar :</span>
					...
					<div class="row">
						<div class="col-sm-3">
							<ul id="product-tabs" class="nav nav-tabs nav-tab-cell">
								<li class="active"><a data-toggle="tab" href="#description">ÜRÜN BİLGİLERİ</a></li>
								<li><a data-toggle="tab" href="#review">YORUM</a></li>
...
?>
											...
											<div class="reviews" style="border: solid 1px #000; padding-left: 2% ">
												<div class="review">
													...
													<div class="text"><b>Kalite :</b>  <?php echo htmlentities($rvw['quality']);?> Puan</div>
													<div class="text"><b>Fiyat :</b>  <?php echo htmlentities($rvw['price']);?> Puan</div>
													<div class="text"><b>Performans :</b>  <?php echo htmlentities($rvw['value']);?> Puan</div>
										...
										<div class="product-add-review">
											<h4 class="title">Kendi Yorumunuzu Yazın</h4>
												...
												<div class="table-responsive">
													<table class="table table-bordered">	
														...
														<tbody>
															...
															<tr>
																<td class="cell-label">Performans</td>
														...
														<div class="row">
															<div class="col-sm-6">
																<div class="form-group">
																	<label for="exampleInputName">Adınız <span class="astk">*</span></label>
																<input type="text" class="form-control txt" id="exampleInputName" placeholder="" name="name" required="required">
																</div><!-- /.form-group -->
																<div class="form-group">
																	<label for="exampleInputSummary">Özet <span class="astk">*</span></label>
															...
															<div class="col-md-6">
																<div class="form-group">
																	<label for="exampleInputReview">Yorum <span class="astk">*</span></label>
...
<textarea class="form-control txt txt-review" id="exampleInputReview" rows="4" placeholder="" name="review" required="required"></textarea>
														...
														<div class="action text-right">
															<button name="submit" class="btn btn-primary btn-upper">Yorumu Gönder</button>
														</div><!-- /.action -->
...
while($rw=mysqli_fetch_array($qry))
{
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					<?php echo htmlentities($rw['productPrice']);?>	TL		</span>
										     <span class="price-before-discount">
										     <?php echo htmlentities($rw['productPriceBeforeDiscount']);?>TL</span>
				...
				<div class="action">
					<ul class="list-unstyled">
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rw['id']; ?>" class="lnk btn btn-primary">SEPETE EKLE</a>
