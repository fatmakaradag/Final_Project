...
date_default_timezone_set('Asia/Istanbul');// change according timezone
...
{
alert("Parola Doğrulama Alanı Boş !!");
...
<div class="form-group">
					    <label class="info-title" for="name">Isim<span>*</span></label>
						...
						<div class="form-group">
					    <label class="info-title" for="exampleInputEmail1">Mail Adresi <span>*</span></label>
			 <input type="email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" value="<?php echo $row['email'];?>" readonly>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Contact No.">Telefon Numarası <span>*</span></label>
...
<div class="form-group">
					    <label class="info-title" for="Current Password">Mevcut Sifre<span>*</span></label>
						...
						<div class="form-group">
					    <label class="info-title" for="New Password">Yeni Sifre <span>*</span></label>
			 <input type="password" class="form-control unicase-form-control text-input" id="newpass" name="newpass">
					  </div>
					  <div class="form-group">
					    <label class="info-title" for="Confirm Password">Sifreyi Doğrula <span>*</span></label>
					    <input type="password" class="form-control unicase-form-control text-input" id="cnfpass" name="cnfpass" required="required" >
					  </div>
					  <button type="submit" name="submit" class="btn-upper btn btn-primary checkout-page-button">Degistir </button>
					</form> 
