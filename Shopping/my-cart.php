		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-qty item">Özellikler</th>
					<th class="cart-sub-total item">Ürün Fiyatı</th>
					<th class="cart-sub-total item">Kargo Bedeli</th>
					<th class="cart-total last-item">Toplam Tutar</th>
				</tr>
			</thead><!-- /thead -->
			<tfoot>
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								<a href="index.php" class="btn btn-upper btn-primary outer-left-xs">ALIŞVERİŞE DEVAM ET</a>
								<input type="submit" name="submit" value="SEPETİ GÜNCELLE" class="btn btn-upper btn-primary pull-right outer-right-xs">
							</span>
...
?>
								<div class="reviews">
									( <?php echo htmlentities($num);?> Yorumlar )
								</div>
								<?php } ?>
							</div>
						</div><!-- /.row -->
					...
					<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo $row['productPrice']." "."TL"; ?></span></td>
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo $row['shippingCharge']." "."TL"; ?></span></td>

					<td class="cart-product-grand-total"><span class="cart-grand-total-price"><?php echo ($_SESSION['cart'][$row['id']]['quantity']*$row['productPrice']+$row['shippingCharge']); ?> TL</span></td>
				</tr>
...
$_SESSION['pid']=$pdtid;
	...
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">Teslimat Adresi</span>
				</th>
			</tr>
		</thead>
		<tbody>
...
<div class="form-group">
					    <label class="info-title" for="Billing Address">Fatura Adresi<span>*</span></label>
						...
						<div class="form-group">
					    <label class="info-title" for="Billing State ">Ulke  <span>*</span></label>
			 <input type="text" class="form-control unicase-form-control text-input" id="bilingstate" name="bilingstate" value="<?php echo $row['billingState'];?>" required>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Billing City">Sehir <span>*</span></label>
 ...
 <div class="form-group">
					    <label class="info-title" for="Billing Pincode">Posta Kodu <span>*</span></label>
					  ...
					  <button type="submit" name="update" class="btn-upper btn btn-primary checkout-page-button">Guncelle</button>
...
<div class="col-md-4 col-sm-12 estimate-ship-tax">
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">Fatura Adresi</span>
				</th>
			</tr>
		</thead>
		<tbody>
...
<div class="form-group">
					    <label class="info-title" for="Shipping Address">Teslimat Adresi<span>*</span></label>
 ...
 <div class="form-group">
					  ...
					  <button type="submit" name="shipupdate" class="btn-upper btn btn-primary checkout-page-button">Guncelle</button>
					<?php } ?>
			...
			<tr>
				<th>
					...
					<div class="cart-grand-total">
						Toplam<span class="inner-left-md"><?php echo $_SESSION['tp']="$totalprice". "TL"; ?></span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary">ALIŞVERİŞİ BİTİR</button>
