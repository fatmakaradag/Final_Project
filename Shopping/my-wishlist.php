...
?>
						...
						<div class="rating">
							...
							<span class="review">( <?php echo htmlentities($num);?> Yorumlar )</span>
						</div>
						<?php } ?>
						<div class="price"> 
					...
					<td class="col-md-2">
						<a href="my-wishlist.php?page=product&action=add&id=<?php echo $row['pid']; ?>" class="btn-upper btn btn-primary">Sepete Ekle</a>
					</td>
				...
				<?php } } else{ ?>
				<tr>
					<td style="font-size: 18px; font-weight:bold ">Favorileriniz Boş</td>
